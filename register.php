...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO users (user_name, email, first_name, last_name, password) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$user_name, $email, $first_name, $last_name, $hashed_password]);
...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Welcome</h3>
                        <p>Time is the Real Currency! Preserve it wisely</p>
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Join as a Today so you can preserve tommorow</h3>
